...
This project tackles a major issue for current 3D rendering tehnologies in the browser: limited CPU and GPU resources. Our solution is suited for mobile and low powered device or embedded graphical systems with limited processing power or for old system incompatible with the new WegGL technology.
